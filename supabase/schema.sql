...
-- ============================================================
-- Landing page CMS — lets an admin edit every home-page block's
-- copy (and, for list-shaped blocks — features/testimonials/faq —
-- add/remove/reorder items) without a code change. `content` is a
-- per-locale JSON blob whose shape depends on `key`: hero/
-- courses_carousel/pricing_teaser/guarantee are flat {field: string}
-- objects; features/testimonials/faq are {title, items: [...]} —
-- see lib/landing.ts for the typed reader and
-- lib/lms/landing-actions.ts for the admin writer. An item's index
-- must stay aligned across all 3 locales (item 2 in uz, ru, and en
-- is the same person's testimonial / same FAQ question, just
-- translated) — the add/remove/reorder actions enforce that by
-- always operating on all 3 locales' arrays together.
-- Seeded once from the previous hardcoded messages/*.json copy so
-- the home page's content is unchanged on first deploy; re-running
-- this file afterwards never overwrites an admin's edits (ON
-- CONFLICT DO NOTHING), same convention as this file's other seeds.
-- ============================================================
...
drop policy if exists "Landing blocks are public" on public.landing_blocks;
create policy "Landing blocks are public" on public.landing_blocks
  for select using (true);

insert into public.landing_blocks (key, order_index, content) values
  ('hero', 0, '{"uz": {"eyebrow": "O''zbekistondagi amaliy raqamli ko''nikmalar akademiyasi", "title": "Amaliy kasblarni o''rganing", "subtitle": "Marketplace savdosi va AI yordamida mahsulot yaratish bo''yicha real ekspert tajribasiga asoslangan kurslar. Nazariya emas — harakat va natija.", "ctaPrimary": "Kurslarni ko''rish", "ctaSecondary": "Obuna narxlari", "stat1Value": "500 mln so''m", "stat1Label": "Founder oylik aylanma tajribasi", "stat2Value": "7+", "stat2Label": "Yo''nalish", "stat3Value": "3 yil", "stat3Label": "Marketplace amaliy tajriba"}, "ru": {"eyebrow": "Академия практических цифровых навыков в Узбекистане", "title": "Осваивайте востребованные профессии", "subtitle": "Курсы по продажам на маркетплейсах и созданию продуктов с помощью AI, основанные на реальном экспертном опыте. Не теория — действие и результат.", "ctaPrimary": "Смотреть курсы", "ctaSecondary": "Цены на подписку", "stat1Value": "500 млн сум", "stat1Label": "Опыт основателя по месячному обороту", "stat2Value": "7+", "stat2Label": "Направлений", "stat3Value": "3 года", "stat3Label": "Практического опыта на маркетплейсах"}, "en": {"eyebrow": "Uzbekistan''s academy for practical digital skills", "title": "Learn in-demand skills", "subtitle": "Courses on marketplace selling and AI-powered product building, based on real expert experience. Not theory — action and results.", "ctaPrimary": "Browse courses", "ctaSecondary": "See subscription pricing", "stat1Value": "500M sum", "stat1Label": "Founder''s monthly turnover experience", "stat2Value": "7+", "stat2Label": "Tracks", "stat3Value": "3 years", "stat3Label": "Hands-on marketplace experience"}}'::jsonb),
  ('features', 1, '{"uz": {"title": "Nega IZDOSH Academy", "items": [{"title": "Real ekspert tajribasi", "desc": "Nazariyotchi emas — 3 yillik marketplace va 1+ yillik AI-development amaliy tajribaga ega mentor."}, {"title": "Ketma-ket ochiladigan dars tizimi", "desc": "Har bir mavzu avvalgisini tugatib, testdan o''tgach ochiladi — chalg''imasdan, tizimli o''rganasiz."}, {"title": "Kafolat siyosati", "desc": "Birinchi 2 ta darsdan keyin yoqmasa — pulingizni 100% qaytarib beramiz."}, {"title": "3 tilda ta''lim", "desc": "O''zbek, rus va ingliz tillarida — qulay tilda o''rganing."}]}, "ru": {"title": "Почему IZDOSH Academy", "items": [{"title": "Реальный экспертный опыт", "desc": "Не теоретик — ментор с 3-летним опытом на маркетплейсах и 1+ годом практики AI-разработки."}, {"title": "Последовательное открытие уроков", "desc": "Каждая тема открывается после завершения предыдущей и прохождения теста — системное обучение без отвлечений."}, {"title": "Политика гарантии", "desc": "Если после первых 2 уроков не понравится — вернём 100% денег."}, {"title": "Обучение на 3 языках", "desc": "Узбекский, русский и английский — учитесь на удобном языке."}]}, "en": {"title": "Why IZDOSH Academy", "items": [{"title": "Real expert experience", "desc": "Not a theorist — a mentor with 3 years of marketplace selling and 1+ year of hands-on AI development."}, {"title": "Sequential lesson unlocking", "desc": "Each topic unlocks after you finish the previous one and pass its quiz — focused, structured learning."}, {"title": "Guarantee policy", "desc": "Don''t like it after the first 2 lessons? Get a 100% refund, no questions asked."}, {"title": "Taught in 3 languages", "desc": "Uzbek, Russian, and English — learn in the language you''re most comfortable with."}]}}'::jsonb),
  ('courses_carousel', 2, '{"uz": {"title": "Eng zamonaviy kasblar", "subtitle": "Bugungi bozorda eng talab qilinadigan ko''nikmalar"}, "ru": {"title": "Самые современные профессии", "subtitle": "Самые востребованные навыки на сегодняшнем рынке"}, "en": {"title": "The most in-demand skills", "subtitle": "The most sought-after skills in today''s market"}}'::jsonb),
  ('testimonials', 3, '{"uz": {"title": "Bitiruvchilar", "subtitle": "Ular yo''nalishni tugatib, ishga tushirdi", "items": [{"quote": "Uzum Market yo''nalishini tugatib, birinchi oyda 8 mln so''m aylanma qildim. Mentor har bir topshiriqni real vaqtda tekshirdi.", "name": "Nodira Musayeva", "role": "Uzum Market, bitiruvchi"}, {"quote": "China Sourcing kursidan keyin o''zim mustaqil yetkazib beruvchi topib, marjani 2 barobar oshirdim. 12 oyga bo''lib to''langani juda qulay bo''ldi.", "name": "Bekzod Tursunov", "role": "China Sourcing, bitiruvchi"}, {"quote": "AI yo''nalishida birinchi ilovamni ishga tushirdim. Mijoz uchun bot va sayt endi men uchun oddiy ish.", "name": "Dilnoza Karimova", "role": "AI-development, bitiruvchi"}]}, "ru": {"title": "Выпускники", "subtitle": "Они завершили направление и запустили дело", "items": [{"quote": "Завершив направление Uzum Market, за первый месяц сделал оборот в 8 млн сумов. Ментор проверял каждое задание в реальном времени.", "name": "Нодира Мусаева", "role": "Uzum Market, выпускница"}, {"quote": "После курса China Sourcing сам нашёл поставщика и увеличил маржу в 2 раза. Рассрочка на 12 месяцев была очень удобной.", "name": "Бекзод Турсунов", "role": "China Sourcing, выпускник"}, {"quote": "В AI-направлении запустил своё первое приложение. Бот и сайт для клиента теперь для меня обычная работа.", "name": "Дилноза Каримова", "role": "AI-development, выпускница"}]}, "en": {"title": "Graduates", "subtitle": "They finished the track and launched a business", "items": [{"quote": "After finishing Uzum Market, I made 8M so''m in turnover in the first month. The mentor reviewed every assignment in real time.", "name": "Nodira Musayeva", "role": "Uzum Market graduate"}, {"quote": "After China Sourcing I found my own supplier and doubled my margin. Splitting the price over 12 months made it easy to start.", "name": "Bekzod Tursunov", "role": "China Sourcing graduate"}, {"quote": "In the AI track I shipped my first real product. Building a bot or a site for a client is now routine work for me.", "name": "Dilnoza Karimova", "role": "AI-development graduate"}]}}'::jsonb),
  ('pricing_teaser', 4, '{"uz": {"title": "Alohida kurs yoki to''liq obuna", "subtitle": "Bitta yo''nalishni chuqur o''rganing yoki obuna orqali barcha kurslarga kirish huquqini oling", "cta": "Narxlarni ko''rish"}, "ru": {"title": "Отдельный курс или полная подписка", "subtitle": "Глубоко изучите одно направление или получите доступ ко всем курсам по подписке", "cta": "Смотреть цены"}, "en": {"title": "A single course or a full subscription", "subtitle": "Go deep on one track, or unlock every course with a subscription", "cta": "See pricing"}}'::jsonb),
